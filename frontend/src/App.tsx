...
import { School, Psychology, Quiz, CloudUpload, LibraryBooks, AutoAwesome, Chat, Settings, RateReview } from '@mui/icons-material';
        ...
        <>
          ...
          <Paper elevation={2} sx={{ mb: 4 }}>
            ...
            >
              ...
              <Tab label="Question Review" icon={<RateReview />} />
