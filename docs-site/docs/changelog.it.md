...
Modifiche e novità su ExamCraft AI.
...
- Documentazione completa per l'utente finale su [docs.examcraft.ch](https://docs.examcraft.ch)
- Flusso di lavoro Generazione domande → Review Queue → Exam Composer come filo conduttore attraverso la piattaforma

### Marzo 2026

- Smart Help Widget e Docs-Site (in sviluppo)
- Infrastruttura internazionalizzazione (i18n)
- Auto Composition Engine

### Versioni precedenti

Le modifiche dettagliate si trovano nel [Repository GitHub](https://github.com/talent-factory/examcraft/blob/main/CHANGELOG.md).
