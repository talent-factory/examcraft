...
Changes and news for ExamCraft AI.
...
- Complete end-user documentation at [docs.examcraft.ch](https://docs.examcraft.ch)
- Workflow question generation → Review Queue → Exam Composer as red thread through platform

### March 2026

- Smart Help Widget and Docs-Site (in development)
- Internationalization (i18n) infrastructure
- Auto Composition Engine

### Earlier Versions

Detailed changes can be found in the [GitHub Repository](https://github.com/talent-factory/examcraft/blob/main/CHANGELOG.md).
