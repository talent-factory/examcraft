...
def upgrade() -> None:
    op.add_column('question_generation_jobs', sa.Column('topic', sa.String(), nullable=True))
    op.add_column('question_generation_jobs', sa.Column('question_count', sa.Integer(), nullable=True))
    op.add_column('question_generation_jobs', sa.Column('status', sa.String(), server_default='PENDING', nullable=False))
