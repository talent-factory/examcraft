...
def upgrade() -> None:
    ...
    op.add_column(
        "help_faq_cache", sa.Column("approved_by", sa.Integer(), nullable=True)
    )
    op.add_column(
        "help_faq_cache", sa.Column("cluster_id", sa.Integer(), nullable=True)
    )
    op.add_column(
        "help_faq_cache",
        sa.Column(
            "faq_status", sa.String(20), server_default="vorgeschlagen", nullable=False
        ),
    )
