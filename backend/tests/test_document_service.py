...
class TestDocumentService:
    ...
    @pytest.mark.asyncio
    async def test_save_file_to_disk(self, document_service, mock_upload_file, temp_upload_dir):
    ...
    @patch('magic.from_file')
    def test_detect_mime_type_fallback(self, mock_magic, document_service, temp_upload_dir):
    ...
    async def test_upload_document_success(self, mock_uuid, document_service, mock_upload_file):
        ...
        with patch.object(document_service, '_detect_mime_type', return_value="text/plain"):
            # Test
