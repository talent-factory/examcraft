...
def test_premium_portfolio_classification_task_registration_empty_in_core_mode():
    from celery_app import _resolve_premium_portfolio_classification_task_registration

    routes = _resolve_premium_portfolio_classification_task_registration("core")
    assert routes == {}


def test_premium_portfolio_classification_task_registration_reflects_actual_importability_in_full_mode():
    from celery_app import _resolve_premium_portfolio_classification_task_registration
    ...
    routes = _resolve_premium_portfolio_classification_task_registration("full")
...
def test_portfolio_classification_task_is_registered_and_routed_in_running_app():
    from celery_app import celery_app
