...
class TestClaudeAPIEndpoints:
    ...
    def test_generate_exam_endpoint_with_claude_success(self, client, mock_claude_service):
        ...
        with patch('main.claude_service', mock_claude_service):
            response = client.post("/api/v1/generate-exam", json={
                "topic": "Python Grundlagen",
                "difficulty": "medium",
                "question_count": 1,
...
class TestClaudeServiceEndToEnd:
    ...
    async def test_full_exam_generation_workflow(self, client):
        ...
        initial_usage = usage_response.json()
        
        # Test 3: Exam Generation
        exam_response = client.post("/api/v1/generate-exam", json={
        ...
        final_usage = final_usage_response.json()
    ...
    def test_concurrent_requests_rate_limiting(self, client):
        ...
        def make_request():
            return client.post("/api/v1/generate-exam", json={
    ...
    def test_error_handling_and_recovery(self, client):
        ...
        test_cases = [
            {"topic": "A" * 1000, "difficulty": "medium", "question_count": 1},  # Sehr langes Topic
            {"topic": "Test", "difficulty": "medium", "question_count": 100},    # Zu viele Fragen
            {"topic": "Test", "difficulty": "impossible", "question_count": 1},  # Invalide Schwierigkeit
        ]
